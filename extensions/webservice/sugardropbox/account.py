...
ICONS_PATH = os.path.join(env.get_profile_path(),
    'extensions', 'webservice', 'sugardropbox', 'icons')

theme = Gtk.IconTheme.get_default()
theme.append_search_path(ICONS_PATH)

ACCOUNT_DESCRIPTION = _('Upload to Dropbox')
ACCOUNT_NAME = _('Sugar Dropbox')
ACCOUNT_ICON = 'sugardropbox'
USER_FILES = os.path.join(env.get_profile_path(), 'dropbox_files')
